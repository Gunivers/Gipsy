...
async def get_corresponding_answer(channel: nextcord.TextChannel, message: nextcord.Message):
...
async def sendMessage(msg: nextcord.Message, webhook: nextcord.Webhook, username: str, pp_guild: bool):
